...
public class SchedulerCenterServer : ISchedulerCenter
{
    ...
    /// </summary>
    /// <returns></returns>
    public async Task<JobResult<string>> StartScheduleAsync()
    {
    ...
    /// </summary>
    /// <returns></returns>
    public async Task<JobResult<string>> StopScheduleAsync()
    {
        var result = new JobResult<string>();
        try
        {
    ...
    /// <returns></returns>
    public async Task<JobResult<string>> AddScheduleJobAsync(TasksQz tasksQz)
    {
        var result = new JobResult<string>();
    ...
    /// </summary>
    /// <returns></returns>
    public async Task<JobResult<string>> StopScheduleJobAsync(TasksQz sysSchedule)
    {
        var result = new JobResult<string>();
        try
        {
    ...
    /// <returns></returns>
    public async Task<JobResult<string>> ResumeJob(TasksQz sysSchedule)
    {
        var result = new JobResult<string>();
        try
        {
    ...
    /// <param name="sysSchedule"></param>
    /// <returns></returns>
    public async Task<JobResult<string>> PauseJob(TasksQz sysSchedule)
    {
        var result = new JobResult<string>();
        try
        {
    ...
    /// <param name="tasksQz"></param>
    /// <returns></returns>
    public async Task<JobResult<string>> ExecuteJobAsync(TasksQz tasksQz)
    {
        var result = new JobResult<string>();
        try
        {
